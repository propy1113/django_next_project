...
export default function Home() {
  ...
  //       <h1 className="text-2xl font-bold mb-6">フォーム入力画面</h1>
  ...
  //       <h1 className="text-3xl font-semibold mb-6 text-center text-gray-700">フォーム入力画面</h1>
  ...
  //             onChange={handleChange}
  //             required
  //             className="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
  //           />
  //         </div>
  //         <div>
  ...
  //         </div>
  //         <div>
  //           <label className="block text-sm font-medium text-gray-600">ノート</label>
  //           <textarea
  //             name="note"
  //             value={formData.note}
  //             onChange={handleChange}
  ...
  //         <button
  //           type="submit"
  //           className="w-full bg-indigo-500 text-white py-3 rounded-lg shadow-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
  //         >
  //           送信
  //         </button>
  //       </form>
  ...
  //     <div className="bg-white p-12 rounded-xl shadow-2xl w-full max-w-xl">
  //       <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-800">フォーム入力画面</h1>
  ...
  //             onChange={handleChange}
  //             required
  //             className="mt-2 block w-full px-5 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
  //           />
  //         </div>
  //         <div>
  //           <label className="block text-sm font-medium text-gray-600">メール</label>
  ...
  //         <button
  //           type="submit"
  //           className="w-full bg-green-500 text-white py-3 rounded-lg shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
  //         >
  //           送信
  //         </button>
  //       </form>
  ...
  //       <h1 className="text-xl font-semibold mb-4 text-center text-gray-700">フォーム入力画面</h1>
  //       <form onSubmit={handleSubmit} className="space-y-4">
  //         <div>
  //           <label className="block text-sm font-medium text-gray-600">名前</label>
  //           <input
  ...
  //         <button
  //           type="submit"
  //           className="w-full bg-purple-500 text-white py-2 px-4 rounded-md shadow-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
  //         >
  //           送信
  //         </button>
  //       </form>
